   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         ...
         case -3:
            ...
            var r14 = new WyJS.Integer(Math.min(r15.val, r17.val));
            ...
            var r19 = new WyJS.Integer(Math.max(r20.val, r22.val));
         ...
         case -4:
            ...
            var r23 = new WyJS.Integer(Math.min(r24.val, r26.val));
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         ...
         case -6:
            ...
            var r10 = new WyJS.Integer(Math.min(r11.val, r13.val));
            ...
            var r15 = new WyJS.Integer(Math.max(r16.val, r18.val));
         ...
         case -7:
            ...
            var r19 = new WyJS.Integer(Math.min(r20.val, r22.val));
