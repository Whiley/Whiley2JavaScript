...
WyJS.Byte = function (i) {
  if (i.val !== undefined) {
    this.val = i.val;
    print("val "+this.val);
    this.pure = i.val.slice(0, -1);
    print("pure "+this.pure);
  }
  else {
    this.val = i;
    print("val "+this.val);
    this.pure = i.slice(0, -1);
    print("pure "+this.pure);
  }
...
WyJS.Byte.method('sll', function(value){
	print("sll "+(this.pure << value.val)+"b" +" this.pure: " + this.pure + " value: " + value.val);
	return new WyJS.Byte((this.pure << value)+"b");
});

WyJS.Byte.method('srl', function(value){
	print("srl "+(this.pure >>> value.val)+"b");
