function f$Z9bFa7$WL1d$FK$s5$d0kQ$s5$J0FT$$6$_0kM$N4$W0$Q$Z5$Z0kM$Vn0FQ$B6$b0$K$Z6$k0FO(r0){//function(UnionType_Valid_8:msgType) -> any
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r6 = new WyJS.Record(["op", "payload"], [r1, r5], new WyJS.Type.Record(["op", "payload"], [new WyJS.Type.Int(), new WyJS.Type.List(new WyJS.Type.Int())]));
