   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         ...
         case 505:
            ...
            var r30 = new WyJS.List([r27, r28, r29], new WyJS.Type.List(new WyJS.Type.Union([new WyJS.Type.Int(), new WyJS.Type.Real()])));
            var r31 = new WyJS.List([r30], new WyJS.Type.List(new WyJS.Type.List(new WyJS.Type.Union([new WyJS.Type.Int(), new WyJS.Type.Real()]))));
         ...
         case 506:
            ...
            var r40 = new WyJS.List([r37, r38, r39], new WyJS.Type.List(new WyJS.Type.Union([new WyJS.Type.Int(), new WyJS.Type.Real()])));
            var r41 = new WyJS.List([r40], new WyJS.Type.List(new WyJS.Type.List(new WyJS.Type.Union([new WyJS.Type.Int(), new WyJS.Type.Real()]))));
