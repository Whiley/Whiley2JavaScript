   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         ...
         case 1713:
            ...
            r0.setValue(r1, r5);//update %0[%1] = %5 : [int] -> [int]
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            if(WyJS.lt(r0, r1, false)){
               control_flow_pc = 1715;
               control_flow_repeat = true;
               continue outer;
            }
            return r0;//return %0 : int
            control_flow_pc = 1716;
            control_flow_repeat = true;
            continue outer;//goto label1716
         case 1715:
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r11 = new WyJS.List([r2, r4, r6, r7, r9, r10]);
            var r1 = r11.clone();//assign %1 = %11  : [int]
            ...
            var r0 = r12.clone();//assign %0 = %12  : [int]
            ...
            var r19 = new WyJS.List([r13, r14, r15, r16, r17, r18]);
            if(WyJS.equals(r0, r19, true)){
               control_flow_pc = 1717;
               control_flow_repeat = true;
               continue outer;
            }
