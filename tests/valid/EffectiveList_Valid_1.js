   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r6 = WyJS.ArrayGen(r4, r5, new WyJS.Type.Array(new WyJS.Type.Bool()));
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r8 = WyJS.ArrayGen(r6, r7, new WyJS.Type.Array(new WyJS.Type.Bool()));
         ...
         case 1349:
            ...
            var r17 = null;
            var r18 = null;
            var r19 = new WyJS.Array([r15, r16, r17, r18], new WyJS.Type.Array(new WyJS.Type.Null()));
