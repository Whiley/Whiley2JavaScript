function f(r0){//function(UnionType_Valid_7:msgType) -> any
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r6 = new WyJS.Record(["op", "payload"], [r1, r5]);
            var r0 = f(r6);//invoke %0 = (%6) UnionType_Valid_7:f : function(UnionType_Valid_7:msgType) -> any
