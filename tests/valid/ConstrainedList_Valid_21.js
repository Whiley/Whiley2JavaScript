   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         ...
         case -2:
            ...
            var r17 = new WyJS.List([new WyJS.Integer(1), new WyJS.Integer(5), new WyJS.Integer(10), new WyJS.Integer(20), new WyJS.Integer(50), new WyJS.Integer(100), new WyJS.Integer(500), new WyJS.Integer(1000)], new WyJS.Type.List(new WyJS.Type.Int()));
