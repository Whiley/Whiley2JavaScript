   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r6 = new WyJS.List([r2, r3, r4, r5]);
            ...
            var r0 = r10.clone();//assign %0 = %10  : [int]
            ...
            var r0 = r13.clone();//assign %0 = %13  : [int]
