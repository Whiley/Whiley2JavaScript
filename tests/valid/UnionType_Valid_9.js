   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r6 = new WyJS.Record(["data", "op"], [r4, r5], new WyJS.Type.Record(["data", "op"], [new WyJS.Type.Array(new WyJS.Type.Int()), new WyJS.Type.Int()]));
            ...
            var r12 = new WyJS.Record(["data", "op"], [r10, r11], new WyJS.Type.Record(["data", "op"], [new WyJS.Type.Array(new WyJS.Type.Int()), new WyJS.Type.Int()]));
