   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r2 = r3.clone();//assign %2 = %3  : {real x,real y,...}
            var r1 = r2.clone();//assign %1 = %2  : {real x,real y,...}
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r1 = r4.clone();//assign %1 = %4  : {int x,int y}
         ...
         case 1973:
            ...
            var r0 = r9.clone();//assign %0 = %9  : {real x,real y}
