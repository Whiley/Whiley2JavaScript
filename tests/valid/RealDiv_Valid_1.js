...
function f$Z9dFa0Y$3i$(r0, r1){//function(int,int) -> real
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            var r2 = g$Z9bF5B1Fs1E(r0);//invoke %2 = (%0) RealDiv_Valid_1:g : function(int) -> real
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r0 = f$Z9dFa0Y$3i$(r1, r2);//invoke %0 = (%1, %2) RealDiv_Valid_1:f : function(int,int) -> real
