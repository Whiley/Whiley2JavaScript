   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r3 = r7.clone();//assign %3 = %7  : [bool]
            var r0 = r3.clone();//assign %0 = %3  : [bool]
         ...
         case 1207:
            ...
            var r13 = new WyJS.List([r11, r12]);
            var r10 = r13.clone();//assign %10 = %13  : [int]
         ...
         case 1208:
            ...
            var r21 = new WyJS.List([r17, r18, r19, r20]);
            var r16 = r21.clone();//assign %16 = %21  : [real]
            var r2 = r16.clone();//assign %2 = %16  : [real]
