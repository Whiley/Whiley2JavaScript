...
function parseIdentifier$Y9_FP8s1$H0FO$B5$p0VR$B6$d0VS$J5$J0FT$$6$_0kM$N4$W0$Q$Z5$Z0kM$32$qF$J3$s0$R$763y(){//function() -> RecursiveType_Valid_16:Expr
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            var r0 = new WyJS.Array([new WyJS.Integer(101), new WyJS.Integer(114), new WyJS.Integer(114)], new WyJS.Type.Array(new WyJS.Type.Int()));
            var r1 = new WyJS.Record(["err"], [r0], new WyJS.Type.Record(["err"], [new WyJS.Type.Array(new WyJS.Type.Int())]));
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r3 = new WyJS.Array([new WyJS.Integer(101), new WyJS.Integer(114), new WyJS.Integer(114)], new WyJS.Type.Array(new WyJS.Type.Int()));
