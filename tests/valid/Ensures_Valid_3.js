   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         ...
         case 1881:
            ...
            var r25 = WyJS.ArrayGen(r24, r3, new WyJS.Type.Array(new WyJS.Type.Int()));
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r9 = new WyJS.Array([r4, r6, r7, r8], new WyJS.Type.Array(new WyJS.Type.Int()));
            ...
            var r18 = new WyJS.Array([r12, r14, r16, r17], new WyJS.Type.Array(new WyJS.Type.Int()));
