function parse$_9bFaL1i$VJ$J5$Y0FS$76$n0FP$N6$_0$K$Z6$k0FO$w4$L0FN$k5$d0$O$w4$l$$D3$40$T$$6$m00D5ZAw2(r0){//function(int[]) -> RecursiveType_Valid_18:Expr
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r5 = new WyJS.Record(["input", "pos"], [r0, r4], new WyJS.Type.Record(["input", "pos"], [new WyJS.Type.List(new WyJS.Type.Int()), new WyJS.Type.Int()]));
            var r3 = parseAddSubExpr$_9bFaE9oF1$9I$ND$c21h3R0$d$cB$52Vu$FD$a2Vo$kD$92$e$7E$V2Vm$sA$g1Vk$VC$H2$m$sA$X0$R9$a1$u$7B$c2VmP8s1$H0FO$B5$p0VR$B6$d0VS$J5$J0FT$$6$_0kM$N4$W0$Q$Z5$Z0kM$32$sF$J3$s0$R$7rE(r5);//invoke %3 = (%5) RecursiveType_Valid_18:parseAddSubExpr : function(RecursiveType_Valid_18:State) -> {RecursiveType_Valid_18:Expr e,RecursiveType_Valid_18:State st}
...
function parseAddSubExpr$_9bFaE9oF1$9I$ND$c21h3R0$d$cB$52Vu$FD$a2Vo$kD$92$e$7E$V2Vm$sA$g1Vk$VC$H2$m$sA$X0$R9$a1$u$7B$c2VmP8s1$H0FO$B5$p0VR$B6$d0VS$J5$J0FT$$6$_0kM$N4$W0$Q$Z5$Z0kM$32$sF$J3$s0$R$7rE(r0){//function(RecursiveType_Valid_18:State) -> {RecursiveType_Valid_18:Expr e,RecursiveType_Valid_18:State st}
   var control_flow_repeat = true;
   var control_flow_pc = -1;
   outer:
   while(control_flow_repeat){
