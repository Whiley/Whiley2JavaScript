   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            if(r0.f1 ==  r8.f1 && JSON.stringify(r0) ==  JSON.stringify(r8)){//ifeq %0, %8 goto label1229 : {int f1,int f2}
         ...
         case 1229:
            ...
            if(r1.f1 ==  r15.f1 && JSON.stringify(r1) ==  JSON.stringify(r15)){//ifeq %1, %15 goto label1230 : {int f1,int f2}
