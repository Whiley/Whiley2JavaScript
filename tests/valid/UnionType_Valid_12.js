   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r9 = new WyJS.List([r8], new WyJS.Type.List(new WyJS.Type.Real()));
            var r10 = new WyJS.Record(["op", "rest"], [r7, r9], new WyJS.Type.Record(["op", "rest"], [new WyJS.Type.Int(), new WyJS.Type.List(new WyJS.Type.Real())]));
