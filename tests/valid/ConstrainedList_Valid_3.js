   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            while(true){//loop (%2, %3, %8, %10, %11, %12, %13)
               var r8 = r3.length();//lengthof %8 = %3 : [int]
               if(WyJS.equals(r2, r8, false)){
                  control_flow_pc = 1718;
                  control_flow_repeat = true;
                  continue outer;
               }
               while(true){//quantify %9 in %3 () : [int]
               }
               control_flow_pc = 1719;
               control_flow_repeat = true;
               continue outer;//goto label1719
            case 1718:
