   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r14 = new WyJS.List([r5, r9, r13]);
            var r1 = r14.clone();//assign %1 = %14  : [[int]]
            var r0 = r1.clone();//assign %0 = %1  : [[null|int]]
            ...
            var r0 = r15.clone();//assign %0 = %15  : [[null|int]]
            ...
            var r29 = new WyJS.List([r26, r27, r28]);
            var r30 = new WyJS.List([r21, r25, r29]);
            if(WyJS.equals(r0, r30, true)){
               control_flow_pc = 2431;
