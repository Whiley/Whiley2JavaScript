   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r11 = new WyJS.Record(["left", "op", "right"], [r0, r9, r10], new WyJS.Type.Record(["left", "op", "right"], [new WyJS.Type.Record(["op", "left", "right"], [new WyJS.Type.Int(), new WyJS.Type.Int(), new WyJS.Type.Int()]), new WyJS.Type.Int(), new WyJS.Type.Int()]));
            ...
            var r19 = new WyJS.Record(["left", "op", "right"], [r16, r17, r18], new WyJS.Type.Record(["left", "op", "right"], [new WyJS.Type.Record(["op", "left", "right"], [new WyJS.Type.Int(), new WyJS.Type.Int(), new WyJS.Type.Int()]), new WyJS.Type.Int(), new WyJS.Type.Int()]));
         ...
         case 305:
            ...
            var r30 = new WyJS.Record(["left", "op", "right"], [r27, r28, r29], new WyJS.Type.Record(["left", "op", "right"], [new WyJS.Type.Record(["op", "left", "right"], [new WyJS.Type.Int(), new WyJS.Type.Int(), new WyJS.Type.Int()]), new WyJS.Type.Int(), new WyJS.Type.Int()]));
         ...
         case 306:
            ...
            var r37 = new WyJS.Record(["left", "op", "right"], [r34, r35, r36], new WyJS.Type.Record(["left", "op", "right"], [new WyJS.Type.Record(["op", "left", "right"], [new WyJS.Type.Int(), new WyJS.Type.Int(), new WyJS.Type.Int()]), new WyJS.Type.Int(), new WyJS.Type.Int()]));
