   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r9 = f$Y9bFXL1e$FK$s5$d0kQ$s5$J0FT$$6$_0kM$N4$W0$Q$Z5$Z0kM$32$lR$o5$n0kO$F4$t0$R$J531(r0);//invoke %9 = (%0) UnionType_Valid_11:f : function(UnionType_Valid_11:msgType) -> UnionType_Valid_11:msgType
         ...
         case 395:
            var r13 = f$Y9bFXL1e$FK$s5$d0kQ$s5$J0FT$$6$_0kM$N4$W0$Q$Z5$Z0kM$32$lR$o5$n0kO$F4$t0$R$J531(r1);//invoke %13 = (%1) UnionType_Valid_11:f : function(UnionType_Valid_11:msgType) -> UnionType_Valid_11:msgType
