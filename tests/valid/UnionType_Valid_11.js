   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r5 = {op: r3, data: r4};//newrecord %5 = (%3, %4) : {[void] data,int op}
            var r2 = r5;//assign %2 = %5  : {[void] data,int op}
            var r0 = r2;//assign %0 = %2  : {[int] data,int op}
            var r7 = new WyJS.Integer(1);
            var r8 = {index: r7};//newrecord %8 = (%7) : {int index}
            ...
            var r12 = {op: r10, data: r11};//newrecord %12 = (%10, %11) : {[void] data,int op}
         ...
         case 401:
            ...
            var r15 = {index: r14};//newrecord %15 = (%14) : {int index}
