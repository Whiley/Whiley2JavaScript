   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r5 = null;
            var r6 = new WyJS.Record(["x", "y"], [r4, r5], new WyJS.Type.Record(["x", "y"], [new WyJS.Type.Int(), new WyJS.Type.Null()]));
            ...
            var r13 = null;
            var r14 = new WyJS.Record(["x", "y"], [r12, r13], new WyJS.Type.Record(["x", "y"], [new WyJS.Type.Real(), new WyJS.Type.Null()]));
