   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r2 = append$Z9bF1D527RWz(r3);//invoke %2 = (%3) ListAppend_Valid_2:append : function([int]) -> [int]
            var r1 = r2.clone(new WyJS.Type.Int());//assign %1 = %2  : [int]
            var r0 = r1.clone(new WyJS.Type.Int());//assign %0 = %1  : [int]
            var r4 = new WyJS.Integer(97);
            var r5 = new WyJS.Integer(98);
            var r6 = new WyJS.Integer(99);
            var r7 = new WyJS.Integer(100);
            var r8 = new WyJS.Integer(101);
            var r9 = new WyJS.Integer(102);
            var r10 = new WyJS.Integer(103);
            var r11 = new WyJS.Integer(104);
            var r12 = new WyJS.Integer(105);
            var r13 = new WyJS.Integer(106);
            var r14 = new WyJS.Integer(107);
            var r15 = new WyJS.Integer(108);
            var r16 = new WyJS.Integer(109);
            var r17 = new WyJS.Integer(110);
            var r18 = new WyJS.Integer(111);
            var r19 = new WyJS.Integer(112);
            var r20 = new WyJS.Integer(113);
            var r21 = new WyJS.Integer(114);
            var r22 = new WyJS.Integer(115);
            var r23 = new WyJS.Integer(116);
            var r24 = new WyJS.Integer(117);
            var r25 = new WyJS.Integer(118);
            var r26 = new WyJS.Integer(119);
            var r27 = new WyJS.Integer(120);
            var r28 = new WyJS.Integer(121);
            var r29 = new WyJS.Integer(122);
