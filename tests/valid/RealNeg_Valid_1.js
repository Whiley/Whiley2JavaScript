   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r0 = f$Y9bF1B1Fs2(r1);//invoke %0 = (%1) RealNeg_Valid_1:f : function(real) -> real
         ...
         case 1270:
            ...
            var r3 = f$Y9bF1B1Fs2(r4);//invoke %3 = (%4) RealNeg_Valid_1:f : function(real) -> real
         ...
         case 1271:
            ...
            var r6 = f$Y9bF1B1Fs2(r7);//invoke %6 = (%7) RealNeg_Valid_1:f : function(real) -> real
