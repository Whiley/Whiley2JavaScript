   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         ...
         case 2129:
            var r6 = true;
            if(r2 === r6){
               control_flow_pc = 2130;
               control_flow_repeat = true;
               continue outer;
            }
            var r7 = r0.add(r1);//add %7 = %0, %1 : int
            return r7;//return %7 : int
            control_flow_pc = 2131;
            control_flow_repeat = true;
            continue outer;//goto label2131
         case 2130:
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r0 = f(r1, r2);//invoke %0 = (%1, %2) BoolAssign_Valid_6:f : function(int,int) -> int
            var r3 = new WyJS.Integer(123);
            if(WyJS.equals(r0, r3, true)){
               control_flow_pc = 2132;
               control_flow_repeat = true;
               continue outer;
            }
         ...
         case 2132:
            ...
            var r4 = f(r5, r6);//invoke %4 = (%5, %6) BoolAssign_Valid_6:f : function(int,int) -> int
            var r7 = new WyJS.Integer(123);
            if(WyJS.equals(r4, r7, true)){
               control_flow_pc = 2133;
               control_flow_repeat = true;
               continue outer;
            }
            throw {name: 'Assert Failed', message: 'fail'}
         case 2133:
            ...
            var r8 = f(r9, r10);//invoke %8 = (%9, %10) BoolAssign_Valid_6:f : function(int,int) -> int
