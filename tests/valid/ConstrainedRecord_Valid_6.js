   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r13 = new WyJS.Record(["input", "pos"], [r9, r12]);
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r4 = new WyJS.Record(["input", "pos"], [r2, r3]);
            ...
            var r13 = new WyJS.List([r6, r7, r8, r9, r10, r11, r12]);
            var r14 = new WyJS.Integer(2);
            var r15 = new WyJS.Record(["input", "pos"], [r13, r14]);
