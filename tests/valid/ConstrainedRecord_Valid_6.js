   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r4 = r0.input;//fieldload %4 = %0 input : {[int] input,int pos}
            var r5 = r0.pos;//fieldload %5 = %0 pos : {[int] input,int pos}
            var r6 = r4[r5];
            ...
            var r13 = {input: r9, pos: r12};//newrecord %13 = (%9, %12) : {[int] input,int pos}
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r4 = {input: r2, pos: r3};//newrecord %4 = (%2, %3) : {[int+] input,int pos}
            ...
            var r13 = [r6, r7, r8, r9, r10, r11, r12];
            var r14 = new WyJS.Integer(2);
            var r15 = {input: r13, pos: r14};//newrecord %15 = (%13, %14) : {[int] input,int pos}
