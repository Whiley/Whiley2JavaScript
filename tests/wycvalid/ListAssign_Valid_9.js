   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            if(r10  ==  r11){//ifeq %10, %11 goto label37 : int
               control_flow_pc = 37;
         ...
         case 37:
            ...
            if(r13  ==  r14){//ifeq %13, %14 goto label38 : int
               control_flow_pc = 38;
               control_flow_repeat = true;
               continue outer;
            }
         ...
         case 38:
            ...
            if(r16  ==  r17){//ifeq %16, %17 goto label39 : int
               control_flow_pc = 39;
               control_flow_repeat = true;
               continue outer;
            }
         ...
         case 39:
            ...
            if(r19  ==  r20){//ifeq %19, %20 goto label40 : int
               control_flow_pc = 40;
               control_flow_repeat = true;
               continue outer;
            }
