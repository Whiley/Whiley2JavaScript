   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r7 = f(r1);//invoke %7 = (%1) Function_Valid_17:f : function(int) -> int
            r0 = r7;//assign %0 = %7  : int
         case 270:
            var r9 = g(r0, r1);//invoke %9 = (%0, %1) Function_Valid_17:g : function(int,int) -> int
            r8 = r9;//assign %8 = %9  : int
