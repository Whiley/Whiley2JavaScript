function f(r0){//function(TypeEquals_Valid_1:expr) -> bool
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r3 = f(r0);//invoke %3 = (%0) TypeEquals_Valid_1:f : function(TypeEquals_Valid_1:expr) -> bool
            var r4 = true;
            if(r3 === r4){
               control_flow_pc = 4;
               control_flow_repeat = true;
         ...
         case 4:
            ...
            var r8 = f(r0);//invoke %8 = (%0) TypeEquals_Valid_1:f : function(TypeEquals_Valid_1:expr) -> bool
            var r9 = false;
            if(r8 === r9){
               control_flow_pc = 5;
               control_flow_repeat = true;
