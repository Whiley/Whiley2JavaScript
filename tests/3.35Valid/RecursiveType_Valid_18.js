function parse(r0){//function([int]) -> RecursiveType_Valid_18:Expr
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r3 = parseAddSubExpr(r5);//invoke %3 = (%5) RecursiveType_Valid_18:parseAddSubExpr : function(RecursiveType_Valid_18:State) -> {RecursiveType_Valid_18:Expr e,RecursiveType_Valid_18:State st}
...
function parseAddSubExpr(r0){//function(RecursiveType_Valid_18:State) -> {RecursiveType_Valid_18:Expr e,RecursiveType_Valid_18:State st}
   var control_flow_repeat = true;
   var control_flow_pc = -1;
   outer:
   while(control_flow_repeat){
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r2 = parse(r3);//invoke %2 = (%3) RecursiveType_Valid_18:parse : function([int]) -> RecursiveType_Valid_18:Expr
