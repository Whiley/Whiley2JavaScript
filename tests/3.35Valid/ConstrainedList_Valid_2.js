   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            return r0;//return %0 : int
            control_flow_pc = 1669;
            control_flow_repeat = true;
            continue outer;//goto label1669
         case 1668:
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r11 = new WyJS.List([r2, r4, r6, r7, r9, r10], new WyJS.List('int'));
            ...
            var r19 = new WyJS.List([r13, r14, r15, r16, r17, r18], new WyJS.List('int'));
            if(WyJS.equals(r0, r19, true)){
               control_flow_pc = 1670;
               control_flow_repeat = true;
               continue outer;
            }
