   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r6 = new WyJS.List([r3, r4, r5], new WyJS.List('real'));
            var r7 = new WyJS.Record(["items"], [r6], new WyJS.Type.Record(["items"], '{[real] items}'));
            r2 = r7;//assign %2 = %7  : {[real] items}
            r0 = r2;//assign %0 = %2  : {[real] items}
            var r9 = r0.fieldLoad("items");//fieldload %9 = %0 items : {[real] items}
            var r10 = new WyJS.Integer(1);
            var r11 = r9.getValue(r10);
            r8 = r11;//assign %8 = %11  : real
            r1 = r8;//assign %1 = %8  : real
