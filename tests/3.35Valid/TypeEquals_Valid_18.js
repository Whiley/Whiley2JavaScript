   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r0 = f(r8);//invoke %0 = (%8) TypeEquals_Valid_18:f : function([int|real]) -> [int]
         ...
         case 3:
            ...
            var r17 = f(r18);//invoke %17 = (%18) TypeEquals_Valid_18:f : function([int|real]) -> [int]
         ...
         case 4:
            ...
            var r20 = f(r24);//invoke %20 = (%24) TypeEquals_Valid_18:f : function([int|real]) -> [int]
         ...
         case 5:
            ...
            var r29 = f(r33);//invoke %29 = (%33) TypeEquals_Valid_18:f : function([int|real]) -> [int]
