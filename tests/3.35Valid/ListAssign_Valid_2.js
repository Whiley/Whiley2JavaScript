   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            control_flow_repeat = true;
            continue outer;//goto label2366
         case 2365:
            var r8 = new WyJS.Integer(1);
            var r9 = new WyJS.List([r8], new WyJS.List('int'));
            var r10 = new WyJS.Integer(2);
            var r11 = new WyJS.Integer(3);
            var r12 = new WyJS.List([r10, r11], new WyJS.List('int'));
            var r13 = new WyJS.Integer(5);
            var r14 = new WyJS.List([r13], new WyJS.List('int'));
            var r15 = new WyJS.List([r9, r12, r14], new WyJS.List('[int]'));
