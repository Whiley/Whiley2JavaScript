   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         ...
         case 1305:
            ...
            var r35 = new WyJS.List([r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34], new WyJS.List('int'));
         ...
         case 1306:
            ...
            var r50 = new WyJS.List([r39, r40, r41, r42, r43, r44, r45, r46, r47, r48, r49], new WyJS.List('int'));
