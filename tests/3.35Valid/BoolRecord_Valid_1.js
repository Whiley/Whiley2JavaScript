   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r6 = true;
            var r7 = new WyJS.Record(["code", "flag"], [r5, r6], new WyJS.Type.Record(["code", "flag"], '{int code,bool flag}'));
         ...
         case 1441:
            ...
            var r11 = false;
            var r12 = new WyJS.Record(["code", "flag"], [r10, r11], new WyJS.Type.Record(["code", "flag"], '{int code,bool flag}'));
