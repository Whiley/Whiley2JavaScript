   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r4 = new WyJS.Record(["x", "y"], [r0, r1], new WyJS.Type.Record(["x", "y"], '{int x,int y}'));
            return r4;//return %4 : {int x,int y}
            control_flow_pc = 260;
            control_flow_repeat = true;
            continue outer;//goto label260
         case 259:
            var r5 = new WyJS.Integer(1);
            var r6 = new WyJS.Integer(1);
            var r7 = r6.neg();//neg %7 = %6 : int
            var r8 = new WyJS.Record(["x", "y"], [r5, r7], new WyJS.Type.Record(["x", "y"], '{int x,int y}'));
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         ...
         case 261:
            ...
            r0 = r9;//assign %0 = %9  : {int x,int y}
            var r12 = new WyJS.Integer(1);
            var r13 = new WyJS.Integer(2);
            var r14 = new WyJS.Record(["x", "y"], [r12, r13], new WyJS.Type.Record(["x", "y"], '{int x,int y}'));
