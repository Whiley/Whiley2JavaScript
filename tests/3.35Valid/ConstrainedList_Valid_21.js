   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r14 = new WyJS.List([r6, r7, r8, r9, r10, r11, r12, r13], new WyJS.List('int'));
         ...
         case 189:
            ...
            var r28 = new WyJS.List([r20, r21, r22, r23, r24, r25, r26, r27], new WyJS.List('int'));
         ...
         case 190:
            ...
            var r33 = new WyJS.List([r30, r31, r32], new WyJS.List('int'));
            ...
            var r42 = new WyJS.List([r34, r35, r36, r37, r38, r39, r40, r41], new WyJS.List('int'));
