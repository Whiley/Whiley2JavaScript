function f(r0){//function(TypeEquals_Valid_9:expr) -> bool
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r3 = f(r0);//invoke %3 = (%0) TypeEquals_Valid_9:f : function(TypeEquals_Valid_9:expr) -> bool
            var r4 = false;
            if(r3 === r4){
               control_flow_pc = 47;
               control_flow_repeat = true;
         ...
         case 47:
            ...
            var r10 = f(r0);//invoke %10 = (%0) TypeEquals_Valid_9:f : function(TypeEquals_Valid_9:expr) -> bool
            var r11 = true;
            if(r10 === r11){
               control_flow_pc = 48;
               control_flow_repeat = true;
