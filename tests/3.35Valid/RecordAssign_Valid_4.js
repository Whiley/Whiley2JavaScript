function f(r0){//function(RecordAssign_Valid_4:tac2ta) -> RecordAssign_Valid_4:tac2tb
   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r8 = new WyJS.Record(["f1", "f2"], [r6, r7], new WyJS.Type.Record(["f1", "f2"], '{int f1,int f2}'));
         ...
         case 1205:
            ...
            var r12 = f(r0);//invoke %12 = (%0) RecordAssign_Valid_4:f : function(RecordAssign_Valid_4:tac2ta) -> RecordAssign_Valid_4:tac2tb
            r11 = r12;//assign %11 = %12  : {int f1,int f2}
            r1 = r11;//assign %1 = %11  : {int f1,int f2}
            var r13 = new WyJS.Integer(0);
            var r14 = new WyJS.Integer(3);
            var r15 = new WyJS.Record(["f1", "f2"], [r13, r14], new WyJS.Type.Record(["f1", "f2"], '{int f1,int f2}'));
