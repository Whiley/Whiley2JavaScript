   ...
   while(control_flow_repeat){
      ...
      switch(control_flow_pc){
         case -1 :
            ...
            var r4 = new WyJS.Record(["op", "index"], [r2, r3], new WyJS.Type.Record(["op", "index"], '{int index,int op}'));
            r1 = r4;//assign %1 = %4  : {int index,int op}
            r0 = r1;//assign %0 = %1  : {int index,int op}
            var r5 = f(r0);//invoke %5 = (%0) UnionType_Valid_20:f : function(UnionType_Valid_20:byteCode) -> UnionType_Valid_20:byteCode
            var r6 = new WyJS.Integer(1);
            var r7 = new WyJS.Integer(0);
            var r8 = new WyJS.Record(["op", "index"], [r6, r7], new WyJS.Type.Record(["op", "index"], '{int index,int op}'));
