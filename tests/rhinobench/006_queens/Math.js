var WyJS = require("./../WyJS_Runtime.js").WyJS;

exports.abs$Y9bFXA$W = function(r0){//function(int) -> int
...
exports.abs$Y9bF1B1Fs2 = function(r0){//function(real) -> real
   var control_flow_repeat = true;
   var control_flow_pc = -1;
   outer:
   while(control_flow_repeat){
...
exports.max$Y9dFXs1Fs2 = function(r0, r1){//function(int,int) -> int
   var control_flow_repeat = true;
   var control_flow_pc = -1;
   outer:
   while(control_flow_repeat){
...
exports.max$Y9dFX$Y$31 = function(r0, r1){//function(real,real) -> real
   var control_flow_repeat = true;
   var control_flow_pc = -1;
   outer:
   while(control_flow_repeat){
...
exports.min$Y9dFXs1Fs2 = function(r0, r1){//function(int,int) -> int
   var control_flow_repeat = true;
   var control_flow_pc = -1;
   outer:
   while(control_flow_repeat){
...
exports.min$Y9dFX$Y$31 = function(r0, r1){//function(real,real) -> real
   var control_flow_repeat = true;
   var control_flow_pc = -1;
   outer:
   while(control_flow_repeat){
...
exports.pow$Y9dFXs1Fs2 = function(r0, r1){//function(int,int) -> int
   var control_flow_repeat = true;
   var control_flow_pc = -1;
   outer:
   while(control_flow_repeat){
